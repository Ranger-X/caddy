...
<p align="center">
	...
	<a href="https://godoc.org/github.com/Ranger-X/caddy"><img src="https://img.shields.io/badge/godoc-reference-blue.svg"></a>
	<a href="https://goreportcard.com/report/caddyserver/caddy"><img src="https://goreportcard.com/badge/github.com/Ranger-X/caddy"></a>
	<br>
	<a href="https://twitter.com/caddyserver" title="@caddyserver on Twitter"><img src="https://img.shields.io/badge/twitter-@caddyserver-55acee.svg" alt="@caddyserver on Twitter"></a>
	<a href="https://caddy.community" title="Caddy Forum"><img src="https://img.shields.io/badge/community-forum-ff69b4.svg" alt="Caddy Forum"></a>
	<a href="https://sourcegraph.com/github.com/Ranger-X/caddy?badge" title="Caddy on Sourcegraph"><img src="https://sourcegraph.com/github.com/Ranger-X/caddy/-/badge.svg" alt="Caddy on Sourcegraph"></a>
</p>
<p align="center">
...
Available for Windows, Mac, Linux, BSD, Solaris, and [Android](https://github.com/Ranger-X/caddy/wiki/Running-Caddy-on-Android).
...
- **[Latest release](https://github.com/Ranger-X/caddy/releases/latest)** for pre-built, vanilla binaries
...
- Run `go get github.com/Ranger-X/caddy/caddy`
...
import (
	"github.com/Ranger-X/caddy/caddy/caddymain"
...
```
3. `go mod init caddy`
4. Run `go get github.com/Ranger-X/caddy`
...
- Run `git clone https://github.com/Ranger-X/caddy.git` in any folder (doesn't have to be in GOPATH).
...
**[Join our forum](https://caddy.community) where you can chat with other Caddy users and developers!** To get familiar with the code base, try [Caddy code search on Sourcegraph](https://sourcegraph.com/github.com/Ranger-X/caddy/)!

Please see our [contributing guidelines](https://github.com/Ranger-X/caddy/blob/master/.github/CONTRIBUTING.md) for instructions. If you want to write a plugin, check out the [developer wiki](https://github.com/Ranger-X/caddy/wiki).
...
If you want to contribute to the documentation, please [submit an issue](https://github.com/Ranger-X/caddy/issues/new) describing the change that should be made.

### Good First Issue

If you are looking for somewhere to start and would like to help out by working on an existing issue, take a look at our [`Good First Issue`](https://github.com/Ranger-X/caddy/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) tag
